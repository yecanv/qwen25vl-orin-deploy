...
| `raw/` | 全部实验原始输出 28 份 | 含 **vit_orin_wrong_output.npy**(cos 0.1247 翻车物证)、**ncu_vit_st.ncu-rep + 2254 行明细**(采样,vit_fp16_st 引擎 30 kernel,--set basic) |
...
| 资产 | 体积 | 重建方式 | 耗时 |
|---|---|---|---|
| vit_fp16/static/st.engine ×3 | 1.3GB×3 | trtexec 命令在各 build log 抬头 | L2≈53min(复测 56min)/L3≈55min/L4≈119min |
